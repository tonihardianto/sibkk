                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-group">
                                        ...
                                        <h6>Edit Data Alumni</h6>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <?php foreach ($data->result_array() as $i) : ?>
                                    <form method="POST" action="<?php echo base_url() . 'Corp/Siswa/editSiswa' ?>">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="fullname" class="col-sm-2 col-form-label">Nama Lengkap</label>
                                                <div class="col-sm-10">
                                                    <input type="hidden" name="id" id="id" value="<?php echo $i['alumni_id'] ?>">
                                                    <input type="text" class="form-control" name="fullname" id="fullname" value="<?php echo $i['alumni_nama'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="jurusan" class="col-sm-2 col-form-label">Jurusan</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="jurusan" id="jurusan" value="<?php echo $i['alumni_jurusan'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="sekolah" class="col-sm-2 col-form-label">Asal Sekolah</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="sekolah" id="sekolah" value="<?php echo $i['alumni_sekolah'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="posisi" class="col-sm-2 col-form-label">Posisi</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="posisi" id="posisi" value="<?php echo $i['alumni_posisi'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 input-group date" id="reservationdate" data-target-input="nearest">
                                                    <input type="text" name="tgl_masuk" value="<?php echo $i['alumni_masuk'] ?>" class="form-control datetimepicker-input" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-target="#reservationdate" data-mask />
