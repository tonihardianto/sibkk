...
<head>
    ...
    <title>Bursa Kerja Khusus | Pendaftaran</title>
                    ...
                    <div class="row">
                        ...
                        <div class="card card-primary card-outline mx-auto" style="width: 90%;">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Form -->
                                <form method="post" action="<?php echo base_url() . 'Applicant/Register/add_applicant'; ?>" class="form-horizontal" role="form" id="quickForm" enctype="multipart/form-data">
                                    <div id="accordion">
                                        <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group">
                                                            <input onkeypress="return numOnly(event)" type="text" name="tb" class="form-control" id="tb" maxLength="3" placeholder="Tinggi Badan" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" onkeypress="return numOnly(event)" name="bb" class="form-control" id="bb" maxLength="3" placeholder="Berat Badan" required>
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input onkeypress="return numOnly(event)" type="text" name="telepon" class="form-control" id="telepon" maxLength="15" placeholder="Telepon/Hp">
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="text" name="bkk" class="form-control" id="bkk" placeholder="BKK Pengirim " required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $('#quickForm').validate({
                ...
                messages: {
                    ...
                    bkk: {
                        required: "Silahkan Isi BKK Pengirim Anda!"
                    },
