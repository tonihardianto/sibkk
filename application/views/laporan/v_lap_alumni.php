                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-group">
                                        <a href="<?php echo base_url() . 'Admin/Export/alumni' ?>"><button class="btn btn-info">Export <i class="fas fa-print"></i></button></a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody id="show_data">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <!-- <a class="btn btn-xs btn-info" href="<?php echo base_url() . 'Admin/Export/riwayat' ?>?nik=<?php echo $nik; ?>" title="Excel"><span class="fa fa-print"> Excel</span> </a> -->
