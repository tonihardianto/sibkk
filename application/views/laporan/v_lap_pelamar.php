                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-group">
                                        <a href="<?php echo base_url() . 'Admin/Export/pelamar' ?>"><button class="btn btn-info">Export <i class="fas fa-print"></i></button></a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="show_data">
                                            ...
                                            foreach ($data->result_array() as $key) :
                                                ...
                                                $kk = $key['lamar_no_kk'];
                                                $nik = $key['lamar_nik'];
                                                $jurusan = $key['lamar_jurusan'];
                                                $sekolah = $key['lamar_asal_sekolah'];
                                                $telepon = $key['lamar_hp'];
