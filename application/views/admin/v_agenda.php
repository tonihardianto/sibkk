...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo base_url() . 'Admin/Agenda/seeCalender' ?>"><button class="btn btn-info">Kalender <i class="fas fa-calendar-alt"></i></button></a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                         <a class="btn btn-xs btn-warning" href="<?php echo base_url().'Admin/Agenda/getEdit' ?>?id=<?php echo $id; ?>" title="Edit"><span class="fa fa-edit"></span> </a> 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content modal-lg">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url() . 'Admin/Agenda/addAgenda'; ?>" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul Agenda" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="jam" class="col-sm-2 col-form-label">Waktu</label>
                                    <div class="col-sm-10 input-group date" id="timepicker" data-target-input="nearest">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Daetail Agenda</label>
                                    <div class="col-sm-10 card-body pad">
                                        ...
                                        <p class="text-danger">*Tuliskan Informasi Agenda</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        ?>
            <div class="modal fade" id="editAgenda<?php echo $id; ?>">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content modal-lg">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url() . 'Admin/Agenda/editAgenda'; ?>" class="form-horizontal">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="tempat" class="col-sm-2 col-form-label">Tempat</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="tempat" id="tempat" value="<?php echo $tempat; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jam" class="col-sm-2 col-form-label">Waktu</label>
                                        <div class="col-sm-10 input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="text" name="jam" value="<?php echo $time; ?>" class="form-control datetimepicker-input" data-target="#timepicker" />
                                            <div class="input-group-append" data-target="#timepicker" data-toggle="datetimepicker">
                                                <div class="input-group-text"><i class="far fa-clock"></i></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" name="tanggal" value="<?php echo $tgl; ?>" class="form-control datetimepicker-input" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-target="#reservationdate" data-mask />
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Detail Agenda</label>
                                        <div class="col-sm-10 card-body pad">
            ...
            <div class="modal fade" id="myDelete<?php echo $id ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url() . 'Admin/Agenda/delAgenda'; ?>" id="form_sample_1" class="form-horizontal">
                            <div class="modal-body">
                                <p>Yakin ingin menghapus data <b><?php echo $i['evt_name']; ?></b>..?</p>
