                                        ...
                                        <tbody id="show_data">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $key['his_nama']; ?></td>
                                                    <td><?php echo $key['his_nik']; ?></td>
                                                    <td><?php echo $key['his_telepon']; ?></td>
                                                    <td><?php echo $key['his_sekolah']  ?></td>
                                                    <td><?php echo $key['his_company'] ?></td>
                                                    <td><?php echo $key['his_date'] ?></td>
                                                    <!-- <td style="text-align:center;">
                                                        <a class="btn btn-xs btn-warning" href="<?php echo base_url() . 'admin/siswa/get_edit' ?>?Id=<?php echo $id ?>" title="Edit"><span class="fa fa-edit"></span> </a> -->
                                                    ...
                                                    <!-- <a class="btn btn-xs btn-info" href="<?php echo base_url() . 'admin/pelamar/detail/' ?>?nik=<?php echo $nik; ?>" title="Hapus"><span class="fa fa-server"> Detail</span> </a> -->
