...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        ...
                                                        <a class="btn btn-xs btn-info" href="<?php echo base_url() . 'Admin/Loker/export' ?>?id=<?php echo $id;   ?>" title="Laporan"><span class="fa fa-print"></span> </a>
                                                        <a class="btn btn-xs btn-warning" href="<?php echo base_url() . 'Admin/Loker/getEdit' ?>?id=<?php echo $id ?>" title="Edit"><span class="fa fa-edit"></span> </a>
                                                         <a class="btn btn-xs btn-danger" href="#myStatus<?php echo $id; ?>" data-toggle="modal" title="Nonaktif"><span class="fa fa-ban"></span> </a> 
        ...
        <!-- Begin Modal Detail -->
        <?php
        foreach ($stat->result_array() as $a) :
            $id = $a['loker_id'];
            $name = $a['loker_judul'];

        ?>
            <div class="modal fade" id="myStatus<?php echo $id; ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Peringatan</h4>
                        ...
                        <form method="post" action="<?php echo base_url() . 'Admin/Loker/nonAktif'; ?>" id="form_sample_1" class="form-horizontal">
                            <div class="modal-body">
                                <p>Nonaktifkan data <b><?php echo $name; ?></b>..?</p>
                                <input name="id" type="hidden" value="<?php echo $id; ?>">
                            </div>
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-outline-dark" data-dismiss="modal">Batal</button>
                                <button type="submit" class="btn btn-warning"><i class="icon-remove icon-white"></i>Nonaktifkan</button>
                            </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
