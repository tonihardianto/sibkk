...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-group">
                                        <h3>Form Ubah Data Lowongan Pekerjaan</h3>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form method="post" action="<?php echo base_url() . 'Admin/Loker/editLoker'; ?>" class="form-horizontal">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="judul" class="col-sm-2 col-form-label">Perusahaan</label>
                                                <div class="col-sm-10">
                                                <input type="hidden" name="id" value="<?php echo $i['loker_id'] ?>" >
                                                    <input type="text" class="form-control" name="judul" id="judul" value="<?php echo $i['loker_judul'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="posisi" class="col-sm-2 col-form-label">Posisi</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="posisi" id="posisi" value="<?php echo $i['loker_posisi'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 card-body pad">
                                                    <textarea class="textarea" name="detail" placeholder="Tulis Detail Persyaratan " style="width: 100%; height: 20%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; "><?php echo $i['loker_detail'] ?></textarea>
                                                    <p class="text-sm mb-0">
                                                    <p class="text-danger">*Tuliskan Informasi Loker Secara Detail</p>
                                                    </p>
                                                </div>
                                            </div>
                                            <button class="btn btn-lg btn-primary float-left">Simpan</button>
                                        </div>
                                        <!-- /.card-body -->
    ...
    <footer class="main-footer">
        <div class="float-right d-none d-sm-block">
            Develope by <b>Insane Project</b> with  <i class="text-danger fas fa-heart"></i>
        </div>
